            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-400 text-lg">
                        Get help with your internet connection and find answers to common questions
                    </p>
                </div>
                    ...
                    <div className="space-y-4">
                            ...
                            {openIndex === 0 && (
                                <div className="px-6 pb-6 text-gray-300">
                                    <div className="border-t border-gray-700 pt-4 space-y-3">
                                        <p>Restarting your router is a simple but powerful way to fix internet problems. It clears temporary glitches, refreshes your network connection, and can even improve your speed.</p>
                                        <div className="bg-blue-900/30 border-l-4 border-blue-500 p-3 rounded-r">
                                            <p className="text-sm">Restarting helps overloaded routers remove temporary glitches, memory buildup, or slow connections. This gives your router a clean slate so your internet works faster and more reliably.</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {openIndex === 1 && (
                                <div className="px-6 pb-6 text-gray-300">
                                    <div className="border-t border-gray-700 pt-4 space-y-4">
                                        <p>Both 2.4 GHz and 5 GHz bands have pros and cons depending on your situation:</p>
                                        ...
                                        <div className="bg-emerald-900/30 border-l-4 border-emerald-500 rounded-r p-4">
                                            <h4 className="font-semibold text-emerald-300 mb-2">💡 Best Practice: Dual Band Router</h4>
                                            <p className="text-sm text-emerald-200/80">Use a dual-band router to get the best of both worlds - let speed-hungry devices use 5 GHz while distant devices connect via 2.4 GHz.</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {openIndex === 2 && (
                                <div className="px-6 pb-6 text-gray-300">
                                    <div className="border-t border-gray-700 pt-4">
                                        <p>Maxnet offers both <span className="text-blue-300 font-medium">Fiber-optic</span> and <span className="text-purple-300 font-medium">Cable</span> connections, which depend on your usage and requirements. Contact us to find the best option for your location.</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden hover:border-gray-600 transition-colors">
                            ...
                            {openIndex === 3 && (
                                <div className="px-6 pb-6 text-gray-300">
                                    <div className="border-t border-gray-700 pt-4 space-y-3">
                                        <p>Visit our plans section for complete details about all available plans:</p>
                                        <a 
                                            href="/#plan" 
                                    ...
                                    <div className="border-t border-gray-700 pt-4 space-y-3">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-300">Available anytime - instant activation</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <AlertCircle className="w-5 h-5 text-yellow-400 mt-0.5 flex-shrink-0" />
                                            <div>
                                                <p className="font-medium text-yellow-300">Downgrades</p>
                                                <p className="text-sm text-gray-300">Takes effect at the end of your current billing cycle</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden hover:border-gray-600 transition-colors">
                            ...
                            {openIndex === 5 && (
                                <div className="px-6 pb-6 text-gray-300">
                                    <div className="border-t border-gray-700 pt-4 space-y-4">
                                        <p className="font-medium text-yellow-300">Try these troubleshooting steps:</p>
